...
export const TradeData = () => {
	...
	const handleFirstFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
	...
	const handleSecondFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
		event.preventDefault();
		const data = {
			...formData,
			address: event.currentTarget.address.valueOf,
			phone: event.currentTarget.phone.valueOf,
		};
		console.log(data);
